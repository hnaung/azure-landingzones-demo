...
|  $$$$$$/| $$  | $$| $$            | $$  | $$|  $$$$$$/   \  $/ |  $$$$$$$| $$      
 ...
 Expanding variable files: /tf/caf/configuration/demo/level1/*.tfvars
 Expanding variable files: /tf/caf/configuration/demo/level1/*.tfvars.json
...
tf_action                     : 'apply'
command and parameters        : '-var-file /tf/caf/configuration/demo/level1/landingzone.tfvars -parallelism 30'
...
Getting launchpad coordinates from subscription: 9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a
 - keyvault_name: xtzz-kv-level1
 - tenant_id : 360dc172-bb3b-4a57-809f-6b7cbb127b99
 - storage_account_name (current): xtzzstlevel1
 - storage_account_name (lower): xtzzstlevel0
 - resource_group (current): xtzz-rg-launchpad-level1
 - resource_group (lower): xtzz-rg-launchpad-level0
...
@calling plan
running terraform plan with -var-file /tf/caf/configuration/demo/level1/landingzone.tfvars -parallelism 30
 -TF_VAR_workspace: tfstate
 -state: /home/vscode/.terraform.cache/tfstates/level1/tfstate/caf_foundations.tfstate
 -plan:  /home/vscode/.terraform.cache/tfstates/level1/tfstate/caf_foundations.tfplan
...
Saved the plan to: /home/vscode/.terraform.cache/tfstates/level1/tfstate/caf_foundations.tfplan

To perform exactly these actions, run the following command to apply:
    terraform apply "/home/vscode/.terraform.cache/tfstates/level1/tfstate/caf_foundations.tfplan"
Terraform plan return code: 0
@calling apply
running terraform apply
Terraform version 15.
[0m[1mmodule.solution.random_string.prefix[0]: Creating...[0m[0m
[0m[1mmodule.solution.random_string.prefix[0]: Creation complete after 0s [id=qebu][0m
[0m[1m[32m
