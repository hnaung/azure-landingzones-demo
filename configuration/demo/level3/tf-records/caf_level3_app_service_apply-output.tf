...
[0m[1mmodule.solution.random_string.prefix[0]: Creation complete after 0s [id=pufw][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurecaf_name.caf_name_vnet: Creating...[0m[0m
[0m[1mmodule.solution.module.resource_groups["networking_ase"].azurecaf_name.rg: Creating...[0m[0m
[0m[1mmodule.solution.azurecaf_name.route_tables["default_internet"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurecaf_name.caf_name_vnet: Creation complete after 0s [id=amqwrowhnykwysus][0m
[0m[1mmodule.solution.module.app_service_environments["ase1"].azurecaf_name.ase: Creating...[0m[0m
[0m[1mmodule.solution.module.app_service_plans["asp2"].azurecaf_name.plan: Creating...[0m[0m
[0m[1mmodule.solution.azurecaf_name.route_tables["default_internet"]: Creation complete after 0s [id=qbxkstesqubsycih][0m
[0m[1mmodule.solution.module.resource_groups["networking_ase"].azurecaf_name.rg: Creation complete after 0s [id=okbjxykvcvibooow][0m
[0m[1mmodule.solution.azurecaf_name.routes["internet"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["AzureBastionSubnet"]: Creating...[0m[0m
[0m[1mmodule.solution.module.app_service_environments["ase1"].azurecaf_name.ase: Creation complete after 0s [id=ftldqtjhidmcqveq][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["AzureBastionSubnet"]: Creation complete after 0s [id=cefkvaxafrwgkarc][0m
[0m[1mmodule.solution.module.app_service_plans["asp2"].azurecaf_name.plan: Creation complete after 0s [id=kjipokjtwidljfww][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["jumpbox"]: Creating...[0m[0m
[0m[1mmodule.solution.module.resource_groups["asp_region1"].azurecaf_name.rg: Creating...[0m[0m
[0m[1mmodule.solution.module.resource_groups["ase_region1"].azurecaf_name.rg: Creating...[0m[0m
[0m[1mmodule.solution.azurecaf_name.routes["internet"]: Creation complete after 0s [id=erusunwiuxrkmjyg][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["ase3"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["private_endpoints"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["jumpbox"]: Creation complete after 0s [id=mxjftjmworbhndbw][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["ase2"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["ase1"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["private_endpoints"]: Creation complete after 0s [id=kswoshkrmqyhanow][0m
[0m[1mmodule.solution.module.resource_groups["asp_region1"].azurecaf_name.rg: Creation complete after 0s [id=fmwljxucgwqfiiam][0m
[0m[1mmodule.solution.module.resource_groups["ase_region1"].azurecaf_name.rg: Creation complete after 1s [id=dtvraguyaqphbkjy][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["ase2"]: Creation complete after 1s [id=axyjhqlrijbegnth][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["ase3"]: Creation complete after 1s [id=voqlrxqqnvfclmgp][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurecaf_name.nsg_obj["ase1"]: Creation complete after 1s [id=irdxvqcudfhlnkpd][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase2"].azurecaf_name.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase3"].azurecaf_name.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["private_endpoints"].azurecaf_name.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase1"].azurecaf_name.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["private_endpoints"].azurecaf_name.subnet: Creation complete after 0s [id=obfrcteulkibwgru][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase1"].azurecaf_name.subnet: Creation complete after 0s [id=grmxbdaouvmobwbq][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["AzureBastionSubnet"].azurecaf_name.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase3"].azurecaf_name.subnet: Creation complete after 0s [id=vdcmgectnykuxkfa][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase2"].azurecaf_name.subnet: Creation complete after 0s [id=atslykeqacjyambv][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["AzureBastionSubnet"].azurecaf_name.subnet: Creation complete after 0s [id=dlnmedagmvcmlxta][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["jumpbox"].azurecaf_name.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["jumpbox"].azurecaf_name.subnet: Creation complete after 0s [id=pshmxqfolvxwnohm][0m
[0m[1mmodule.solution.module.resource_groups["asp_region1"].azurerm_resource_group.rg: Creating...[0m[0m
[0m[1mmodule.solution.module.resource_groups["networking_ase"].azurerm_resource_group.rg: Creating...[0m[0m
[0m[1mmodule.solution.module.resource_groups["ase_region1"].azurerm_resource_group.rg: Creating...[0m[0m
[0m[1mmodule.solution.module.resource_groups["networking_ase"].azurerm_resource_group.rg: Creation complete after 0s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase][0m
[0m[1mmodule.solution.module.resource_groups["asp_region1"].azurerm_resource_group.rg: Creation complete after 0s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-asp][0m
[0m[1mmodule.solution.module.resource_groups["ase_region1"].azurerm_resource_group.rg: Creation complete after 0s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-ase][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_virtual_network.vnet: Creating...[0m[0m
[0m[1mmodule.solution.module.route_tables["default_internet"].azurerm_route_table.rt: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["jumpbox"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["private_endpoints"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["ase3"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["AzureBastionSubnet"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["ase1"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["ase2"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_virtual_network.vnet: Creation complete after 4s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["AzureBastionSubnet"].azurerm_subnet.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase1"].azurerm_subnet.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["private_endpoints"].azurerm_subnet.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["jumpbox"]: Creation complete after 4s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/networkSecurityGroups/xtzz-nsg-jumpbox][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["AzureBastionSubnet"]: Creation complete after 4s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/networkSecurityGroups/xtzz-nsg-AzureBastionSubnet][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase3"].azurerm_subnet.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["private_endpoints"]: Creation complete after 4s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/networkSecurityGroups/xtzz-nsg-private_endpoints][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["jumpbox"].azurerm_subnet.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase2"].azurerm_subnet.subnet: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["ase3"]: Creation complete after 4s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/networkSecurityGroups/xtzz-nsg-ase3][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["ase2"]: Creation complete after 4s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/networkSecurityGroups/xtzz-nsg-ase2][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.nsg.azurerm_network_security_group.nsg_obj["ase1"]: Creation complete after 4s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/networkSecurityGroups/xtzz-nsg-ase1][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["AzureBastionSubnet"].azurerm_subnet.subnet: Creation complete after 4s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/AzureBastionSubnet][0m
[0m[1mmodule.solution.module.route_tables["default_internet"].azurerm_route_table.rt: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase1"].azurerm_subnet.subnet: Creation complete after 7s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-ase1][0m
[0m[1mmodule.solution.module.route_tables["default_internet"].azurerm_route_table.rt: Creation complete after 11s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/routeTables/xtzz-route-default_internet][0m
[0m[1mmodule.solution.module.routes["internet"].azurerm_route.route: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["private_endpoints"].azurerm_subnet.subnet: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["jumpbox"].azurerm_subnet.subnet: Creation complete after 10s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-jumpbox][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase3"].azurerm_subnet.subnet: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase2"].azurerm_subnet.subnet: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase3"].azurerm_subnet.subnet: Creation complete after 13s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-ase3][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["private_endpoints"].azurerm_subnet.subnet: Creation complete after 17s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-private_endpoints][0m
[0m[1mmodule.solution.module.routes["internet"].azurerm_route.route: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.routes["internet"].azurerm_route.route: Creation complete after 10s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/routeTables/xtzz-route-default_internet/routes/xtzz-rt-internet][0m
[0m[1mmodule.solution.module.networking["ase_region1"].module.subnets["ase2"].azurerm_subnet.subnet: Creation complete after 20s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-ase2][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["ase2"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["AzureBastionSubnet"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["ase1"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["jumpbox"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase2"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase1"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase3"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["private_endpoints"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["ase3"]: Creating...[0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["ase2"]: Creation complete after 3s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-ase2][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["AzureBastionSubnet"]: Creation complete after 7s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/AzureBastionSubnet][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["ase1"]: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase2"]: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase1"]: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["jumpbox"]: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["private_endpoints"]: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["ase3"]: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase3"]: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase1"]: Creation complete after 10s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-ase1][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["ase1"]: Creation complete after 14s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-ase1][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["jumpbox"]: Creation complete after 17s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-jumpbox][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase2"]: Still creating... [20s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["private_endpoints"]: Still creating... [20s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["ase3"]: Still creating... [20s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase3"]: Still creating... [20s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["private_endpoints"]: Creation complete after 20s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-private_endpoints][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_network_security_group_association.nsg_vnet_association["ase3"]: Creation complete after 24s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-ase3][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase2"]: Creation complete after 27s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-ase2][0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase3"]: Still creating... [30s elapsed][0m[0m
[0m[1mmodule.solution.module.networking["ase_region1"].azurerm_subnet_route_table_association.rt["ase3"]: Creation complete after 30s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-networking-ase/providers/Microsoft.Network/virtualNetworks/xtzz-vnet-ase/subnets/xtzz-snet-ase3][0m
[0m[1mmodule.solution.module.app_service_environments["ase1"].azurerm_template_deployment.ase: Creating...[0m[0m
[0m[1mmodule.solution.module.app_service_environments["ase1"].azurerm_template_deployment.ase: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.app_service_environments["ase1"].azurerm_template_deployment.ase: Still creating... [20s elapsed][0m[0m
[0m[1mmodule.solution.module.app_service_environments["ase1"].azurerm_template_deployment.ase: Still creating... [30s elapsed][0m[0m
[0m[1mmodule.solution.module.app_service_environments["ase1"].azurerm_template_deployment.ase: Still creating... [40s elapsed][0m[0m
[0m[1mmodule.solution.module.app_service_environments["ase1"].azurerm_template_deployment.ase: Still creating... [50s elapsed][0m[0m
[0m[1mmodule.solution.module.app_service_environments["ase1"].azurerm_template_deployment.ase: Still creating... [1m0s elapsed][0m[0m
Terraform apply return code: 0
Terraform returned errors:
[31m╷[0m[0m
[31m│[0m [0m[1m[31mError: [0m[0m[1mError waiting for deployment: Code="DeploymentFailed" Message="At least one resource deployment operation failed. Please list deployment operations for details. Please see https://aka.ms/DeployOperations for usage details." Details=[{"code":"BadRequest","message":"{\r\n  \"Code\": \"BadRequest\",\r\n  \"Message\": \"Feature hostingEnvironments is not allowed for a free trial subscription.\",\r\n  \"Target\": null,\r\n  \"Details\": [\r\n    {\r\n      \"Message\": \"Feature hostingEnvironments is not allowed for a free trial subscription.\"\r\n    },\r\n    {\r\n      \"Code\": \"BadRequest\"\r\n    },\r\n    {\r\n      \"ErrorEntity\": {\r\n        \"ExtendedCode\": \"52018\",\r\n        \"MessageTemplate\": \"Feature {0} is not allowed for a free trial subscription.\",\r\n        \"Parameters\": [\r\n          \"hostingEnvironments\"\r\n        ],\r\n        \"Code\": \"BadRequest\",\r\n        \"Message\": \"Feature hostingEnvironments is not allowed for a free trial subscription.\"\r\n      }\r\n    }\r\n  ],\r\n  \"Innererror\": null\r\n}"}][0m
[31m│[0m [0m
[31m│[0m [0m[0m  with module.solution.module.app_service_environments["ase1"].azurerm_template_deployment.ase,
[31m│[0m [0m  on /home/vscode/.terraform.cache/modules/solution/modules/webapps/ase/module.tf line 11, in resource "azurerm_template_deployment" "ase":
[31m│[0m [0m  11: resource "azurerm_template_deployment" "ase" [4m{[0m[0m
[31m│[0m [0m
[31m╵[0m[0m
