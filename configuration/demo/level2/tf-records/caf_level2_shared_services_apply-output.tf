...
|  $$$$$$/| $$  | $$| $$            | $$  | $$|  $$$$$$/   \  $/ |  $$$$$$$| $$      
 ...
 Expanding variable files: /tf/caf/configuration/demo/level2/shared_services/*.tfvars
 Expanding variable files: /tf/caf/configuration/demo/level2/shared_services/*.tfvars.json
...
tf_action                     : 'apply'
command and parameters        : '-var-file /tf/caf/configuration/demo/level2/shared_services/automations.tfvars -var-file /tf/caf/configuration/demo/level2/shared_services/landingzone.tfvars -var-file /tf/caf/configuration/demo/level2/shared_services/recovery_vaults.tfvars -var-file /tf/caf/configuration/demo/level2/shared_services/resource_groups.tfvars -parallelism 30'
...
running terraform plan with -var-file /tf/caf/configuration/demo/level2/shared_services/automations.tfvars -var-file /tf/caf/configuration/demo/level2/shared_services/landingzone.tfvars -var-file /tf/caf/configuration/demo/level2/shared_services/recovery_vaults.tfvars -var-file /tf/caf/configuration/demo/level2/shared_services/resource_groups.tfvars -parallelism 30
 ...
 -state: /home/vscode/.terraform.cache/tfstates/level2/tfstate/caf_shared_services.tfstate
 -plan:  /home/vscode/.terraform.cache/tfstates/level2/tfstate/caf_shared_services.tfplan
...
[1m  # module.solution.module.automations["auto1"].azurecaf_name.auto_account[0m will be created[0m[0m
[0m  [32m+[0m[0m resource "azurecaf_name" "auto_account" {
      [32m+[0m [0m[1m[0mclean_input[0m[0m   = true
      [32m+[0m [0m[1m[0mid[0m[0m            = (known after apply)
      [32m+[0m [0m[1m[0mname[0m[0m          = "autore1"
      [32m+[0m [0m[1m[0mpassthrough[0m[0m   = false
      [32m+[0m [0m[1m[0mprefixes[0m[0m      = [
          [32m+[0m [0m"xtzz",
        ]
      [32m+[0m [0m[1m[0mrandom_length[0m[0m = 0
      [32m+[0m [0m[1m[0mresource_type[0m[0m = "azurerm_automation_account"
      [32m+[0m [0m[1m[0mresult[0m[0m        = (known after apply)
...
[1m  # module.solution.module.automations["auto1"].azurerm_automation_account.auto_account[0m will be created[0m[0m
[0m  [32m+[0m[0m resource "azurerm_automation_account" "auto_account" {
      [32m+[0m [0m[1m[0mdsc_primary_access_key[0m[0m   = (known after apply)
      [32m+[0m [0m[1m[0mdsc_secondary_access_key[0m[0m = (known after apply)
      [32m+[0m [0m[1m[0mdsc_server_endpoint[0m[0m      = (known after apply)
      [32m+[0m [0m[1m[0mid[0m[0m                       = (known after apply)
      ...
      [32m+[0m [0m[1m[0mtags[0m[0m                     = {
          ...
          [32m+[0m [0m"landingzone"   = "shared_services"
          [32m+[0m [0m"level"         = "level2"
          [32m+[0m [0m"module"        = "automation"
          [32m+[0m [0m"rover_version" = "aztfmod/rover:0.15.1-2104.2711"
        }
    }

[1m  # module.solution.module.recovery_vaults["asr1"].azurecaf_name.asr_rg_vault[0m will be created[0m[0m
[0m  [32m+[0m[0m resource "azurecaf_name" "asr_rg_vault" {
      [32m+[0m [0m[1m[0mclean_input[0m[0m   = true
      [32m+[0m [0m[1m[0mid[0m[0m            = (known after apply)
      [32m+[0m [0m[1m[0mname[0m[0m          = "vault_re1"
      [32m+[0m [0m[1m[0mpassthrough[0m[0m   = false
      [32m+[0m [0m[1m[0mprefixes[0m[0m      = [
          [32m+[0m [0m"xtzz",
        ]
      [32m+[0m [0m[1m[0mrandom_length[0m[0m = 0
      [32m+[0m [0m[1m[0mresource_type[0m[0m = "azurerm_recovery_services_vault"
      [32m+[0m [0m[1m[0mresult[0m[0m        = (known after apply)
      [32m+[0m [0m[1m[0mresults[0m[0m       = (known after apply)
      [32m+[0m [0m[1m[0mseparator[0m[0m     = "-"
      [32m+[0m [0m[1m[0muse_slug[0m[0m      = true
...
[1m  # module.solution.module.recovery_vaults["asr1"].azurerm_backup_policy_vm.vm["policy1"][0m will be created[0m[0m
[0m  [32m+[0m[0m resource "azurerm_backup_policy_vm" "vm" {
      [32m+[0m [0m[1m[0mid[0m[0m                             = (known after apply)
      [32m+[0m [0m[1m[0minstant_restore_retention_days[0m[0m = (known after apply)
      [32m+[0m [0m[1m[0mname[0m[0m                           = "VMBackupPolicy1"
      [32m+[0m [0m[1m[0mrecovery_vault_name[0m[0m            = (known after apply)
      [32m+[0m [0m[1m[0mresource_group_name[0m[0m            = (known after apply)
      [32m+[0m [0m[1m[0mtimezone[0m[0m                       = "UTC"

      [32m+[0m [0mbackup {
          [32m+[0m [0m[1m[0mfrequency[0m[0m = "Daily"
          [32m+[0m [0m[1m[0mtime[0m[0m      = "23:00"
        }

      [32m+[0m [0mretention_daily {
          [32m+[0m [0m[1m[0mcount[0m[0m = 10
        }

      [32m+[0m [0mretention_monthly {
          [32m+[0m [0m[1m[0mcount[0m[0m    = 7
          [32m+[0m [0m[1m[0mweekdays[0m[0m = [
              [32m+[0m [0m"Sunday",
              [32m+[0m [0m"Wednesday",
            ]
          [32m+[0m [0m[1m[0mweeks[0m[0m    = [
              [32m+[0m [0m"First",
              [32m+[0m [0m"Last",
            ]
        }

      [32m+[0m [0mretention_weekly {
          [32m+[0m [0m[1m[0mcount[0m[0m    = 42
          [32m+[0m [0m[1m[0mweekdays[0m[0m = [
              [32m+[0m [0m"Friday",
              [32m+[0m [0m"Saturday",
              [32m+[0m [0m"Sunday",
      ...
      [32m+[0m [0mretention_yearly {
          [32m+[0m [0m[1m[0mcount[0m[0m    = 77
          [32m+[0m [0m[1m[0mmonths[0m[0m   = [
              [32m+[0m [0m"January",
            ]
          [32m+[0m [0m[1m[0mweekdays[0m[0m = [
              [32m+[0m [0m"Sunday",
...
[1m  # module.solution.module.recovery_vaults["asr1"].azurerm_recovery_services_vault.asr[0m will be created[0m[0m
[0m  [32m+[0m[0m resource "azurerm_recovery_services_vault" "asr" {
      [32m+[0m [0m[1m[0mid[0m[0m                  = (known after apply)
      [32m+[0m [0m[1m[0mlocation[0m[0m            = "southeastasia"
      [32m+[0m [0m[1m[0mname[0m[0m                = (known after apply)
      [32m+[0m [0m[1m[0mresource_group_name[0m[0m = (known after apply)
      [32m+[0m [0m[1m[0msku[0m[0m                 = "Standard"
      [32m+[0m [0m[1m[0msoft_delete_enabled[0m[0m = true
      [32m+[0m [0m[1m[0mtags[0m[0m                = {
          [32m+[0m [0m"environment"   = "contoso-demo"
          [32m+[0m [0m"landingzone"   = "shared_services"
          [32m+[0m [0m"level"         = "level2"
          [32m+[0m [0m"module"        = "recovery_vault"
          [32m+[0m [0m"rover_version" = "aztfmod/rover:0.15.1-2104.2711"
        }
...
[1m  # module.solution.module.recovery_vaults["asr1"].time_sleep.delay_create[0m will be created[0m[0m
[0m  [32m+[0m[0m resource "time_sleep" "delay_create" {
      [32m+[0m [0m[1m[0mcreate_duration[0m[0m = "60s"
      [32m+[0m [0m[1m[0mid[0m[0m              = (known after apply)
    }

[1m  # module.solution.module.resource_groups["primary"].azurecaf_name.rg[0m will be created[0m[0m
[0m  [32m+[0m[0m resource "azurecaf_name" "rg" {
      [32m+[0m [0m[1m[0mclean_input[0m[0m   = true
      [32m+[0m [0m[1m[0mid[0m[0m            = (known after apply)
      [32m+[0m [0m[1m[0mname[0m[0m          = "sharedsvc_re1"
      [32m+[0m [0m[1m[0mpassthrough[0m[0m   = false
      [32m+[0m [0m[1m[0mprefixes[0m[0m      = [
          [32m+[0m [0m"xtzz",
        ]
...
[1m  # module.solution.module.resource_groups["primary"].azurerm_resource_group.rg[0m will be created[0m[0m
...
Saved the plan to: /home/vscode/.terraform.cache/tfstates/level2/tfstate/caf_shared_services.tfplan

To perform exactly these actions, run the following command to apply:
    terraform apply "/home/vscode/.terraform.cache/tfstates/level2/tfstate/caf_shared_services.tfplan"
Terraform plan return code: 0
@calling apply
running terraform apply
Terraform version 15.
[0m[1mmodule.solution.random_string.prefix[0]: Creating...[0m[0m
[0m[1mmodule.solution.random_string.prefix[0]: Creation complete after 0s [id=rbdl][0m
[0m[1mmodule.solution.module.resource_groups["primary"].azurecaf_name.rg: Creating...[0m[0m
[0m[1mmodule.solution.module.automations["auto1"].azurecaf_name.auto_account: Creating...[0m[0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].azurecaf_name.asr_rg_vault: Creating...[0m[0m
[0m[1mmodule.solution.module.resource_groups["primary"].azurecaf_name.rg: Creation complete after 0s [id=eupctjhyemhppkpv][0m
[0m[1mmodule.solution.module.automations["auto1"].azurecaf_name.auto_account: Creation complete after 0s [id=cnwjajpbrwhlsnfb][0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].azurecaf_name.asr_rg_vault: Creation complete after 0s [id=kshssuovcletbwdt][0m
[0m[1mmodule.solution.module.resource_groups["primary"].azurerm_resource_group.rg: Creating...[0m[0m
[0m[1mmodule.solution.module.resource_groups["primary"].azurerm_resource_group.rg: Creation complete after 1s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-sharedsvc_re1][0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].azurerm_recovery_services_vault.asr: Creating...[0m[0m
[0m[1mmodule.solution.module.automations["auto1"].azurerm_automation_account.auto_account: Creating...[0m[0m
[0m[1mmodule.solution.module.automations["auto1"].azurerm_automation_account.auto_account: Creation complete after 9s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-sharedsvc_re1/providers/Microsoft.Automation/automationAccounts/xtzz-aa-autore1][0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].azurerm_recovery_services_vault.asr: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].azurerm_recovery_services_vault.asr: Creation complete after 12s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-sharedsvc_re1/providers/Microsoft.RecoveryServices/vaults/xtzz-rsv-vaultre1][0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].time_sleep.delay_create: Creating...[0m[0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].azurerm_backup_policy_vm.vm["policy1"]: Creating...[0m[0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].time_sleep.delay_create: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].azurerm_backup_policy_vm.vm["policy1"]: Still creating... [10s elapsed][0m[0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].azurerm_backup_policy_vm.vm["policy1"]: Creation complete after 14s [id=/subscriptions/9a4451ba-9a73-4299-b4b9-5ef5ca6d1a5a/resourceGroups/xtzz-rg-sharedsvc_re1/providers/Microsoft.RecoveryServices/vaults/xtzz-rsv-vaultre1/backupPolicies/VMBackupPolicy1][0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].time_sleep.delay_create: Still creating... [20s elapsed][0m[0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].time_sleep.delay_create: Still creating... [30s elapsed][0m[0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].time_sleep.delay_create: Still creating... [40s elapsed][0m[0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].time_sleep.delay_create: Still creating... [50s elapsed][0m[0m
[0m[1mmodule.solution.module.recovery_vaults["asr1"].time_sleep.delay_create: Creation complete after 1m0s [id=2021-05-23T13:44:57Z][0m
[0m[1m[32m
